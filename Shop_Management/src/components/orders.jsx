...
const OrderManagementSystem = () => {
  ...
  // Simple Truck Rating Modal Component
  const TruckRatingModal = ({ order, onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Assuming a handleRatingSubmit function exists
          ...
          <div className="modal-content">
            <div className="truck-container">
              <div className="truck-body">
                {rating > 0 && (
                  <div className="truck-cargo" style={{ width: `${(rating / 5) * 100}%` }}>
                    <div className="cargo-fill"></div>
                  </div>
                )}
